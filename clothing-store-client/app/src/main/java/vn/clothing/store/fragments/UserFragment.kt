...
class UserFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val items = arrayListOf(
            ItemDashboardViewUser(1,getString(R.string.purchased_history),null,R.drawable.icon_order),
            ItemDashboardViewUser(2,getString(R.string.label_coupon),null,R.drawable.discount),
            ItemDashboardViewUser(3,getString(R.string.label_product_like),null,R.drawable.icon_order),
            ItemDashboardViewUser(4,getString(R.string.label_bounty_hunting),null,R.drawable.icon_order),
        )
