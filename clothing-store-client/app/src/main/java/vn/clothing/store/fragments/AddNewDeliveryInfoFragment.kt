...
import vn.clothing.store.databinding.FragmentAddNewDeliveryInfoBinding
...
class AddNewDeliveryInfoFragment : Fragment(), NewDeliveryInfoContract.View {
   private lateinit var _binding:FragmentAddNewDeliveryInfoBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAddNewDeliveryInfoBinding.inflate(layoutInflater)
