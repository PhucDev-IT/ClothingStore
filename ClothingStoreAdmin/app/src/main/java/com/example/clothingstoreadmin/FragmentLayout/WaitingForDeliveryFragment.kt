...
class WaitingForDeliveryFragment : Fragment() {
    ...
    fun loadNextPage(){
        ...
        orderService.getNextPage(ProgressOrder.PackagingOrder.name){
            if(it.isEmpty()){
                isLastPage.set(true)
                isLoading.set(true)
    ...
    private fun getFirsData(){
        ...
        orderService.getOrderByStatus(ProgressOrder.PackagingOrder.name) {
            if(it.isEmpty()){
                isLoading.set(true)
                isLastPage.set(true)
